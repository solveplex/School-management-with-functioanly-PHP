...
<!-- Mirrored from thememakker.com/swift/university/labels.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2017 19:30:05 GMT -->
<head>
<meta charset="UTF-8">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body"> <span class="label label-default">Default</span> <span class="label label-primary">Primary</span> <span class="label label-success">Success</span> <span class="label label-info">Info</span> <span class="label label-warning">Warning</span> <span class="label label-danger">Danger</span>
                        <hr>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2> LABELS WITH MATERIAL DESIGN COLORS <small>You can use material design color which examples are <code>.bg-pink, bg-red</code> class</small> </h2>
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-more-vert"></i></a>
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="javascript:void(0);">Action</a></li>
                    ...
                    <div class="body"> <span class="label bg-red">Red</span> <span class="label bg-pink">Pink</span> <span class="label bg-purple">Purple</span> <span class="label bg-deep-purple">Deep Purple</span> <span class="label bg-indigo">Indigo</span> <span class="label bg-blue">Blue</span> <span class="label bg-light-blue">Light Blue</span> <span class="label bg-cyan">Cyan</span> <span class="label bg-teal">Teal</span> <span class="label bg-green">Green</span> <span class="label bg-light-green">Light Green</span> <span class="label bg-lime">Lime</span> <span class="label bg-yellow">Yellow</span> <span class="label bg-amber">Amber</span> <span class="label bg-orange">Orange</span> <span class="label bg-deep-orange">Deep Orange</span> <span class="label bg-brown">Brown</span> <span class="label bg-grey">Grey</span> <span class="label bg-blue-grey">Blue Grey</span> <span class="label bg-black">Black</span> </div>
                </div>
            </div>
        </div>
