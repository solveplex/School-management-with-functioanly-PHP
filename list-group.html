...
<!-- Mirrored from thememakker.com/swift/university/list-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2017 19:30:05 GMT -->
<head>
<meta charset="UTF-8">
            ...
            <ul class="list">
                ...
                <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>User Interface (UI)</span> </a>
                    <ul class="ml-menu">
                        ...
                        <li class="active"><a href="list-group.html">List Group</a> </li>
