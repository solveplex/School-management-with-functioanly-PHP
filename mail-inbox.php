                ...
                <main id="inbox">
                    ...
                    <header class="header">
                        <div class="search-box">
                            ...
                            <span class="icon zmdi zmdi-search"></span> </div>
                    ...
                    <div class="action-bar">
                        <ul>
                            <li><a class="btn btn-raised btn-sm"><i class="zmdi zmdi-chevron-down"></i></a></li>
                            <li><a class="btn btn-raised btn-sm"><i class="zmdi zmdi-refresh"></i></a></li>
                            <li><a class="btn btn-raised btn-sm"><i class="zmdi zmdi-forward"></i></a></li>
                            <li><a class="btn btn-raised btn-sm"><i class="zmdi zmdi-delete"></i></a></li>
                            <li><a class="btn btn-raised btn-sm"><i class="zmdi zmdi-flag"></i></a></li>
                        </ul>
                    </div>
                    <div id="main-nano-wrapper" class="nano">
                        <div class="nano-content">
                                ...
                                <li class="unread">
                                    <div class="col col-1"> <span class="dot"></span>
                                        <div class="checkbox-wrapper">
                                            ...
                                            <i class="zmdi zmdi-star-outline"></i> </div>
                            ...
                            <a href="#" class="load-more-link">Show more messages</a> </div>
                    </div>
                </main>
                <div id="message">
                    <div class="header">
                        <h1 class="page-title">Process<span class="grey">(6)</span></h1>
                        ...
                        <div class="nano-content">
                            <ul class="message-container">
                                <li class="sent">
                                    ...
                                    <div class="tool-box"> <a class="btn btn-raised btn-sm"><i class="zmdi zmdi-forward"></i></a> <a class="btn btn-raised btn-sm"><i class="zmdi zmdi-delete"></i></a> <a class="btn btn-raised btn-sm"><i class="zmdi zmdi-flag"></i></a> </div>
                                </li>
                                <li class="received">
                                    <div class="details">
...
<script src="assets/js/pages/inbox/inbox.js"></script> 
<script src="assets/js/pages/index.js"></script>
</body>

<!-- Mirrored from thememakker.com/swift/university/mail-inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2017 19:27:45 GMT -->
</html>